...
<header class="animate-fade-down fixed top-0 z-20 w-full overflow-hidden" x-data="{ scrolled: false }"
    ...
    <div class="bg-primary border-primary-dark absolute left-0 top-0 h-full w-full border-b-2 shadow-2xl transition-all"
        x-show="scrolled" x-transition:enter-start="opacity-0 -translate-y-10"
